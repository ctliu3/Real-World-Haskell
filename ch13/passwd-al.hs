...
main = do
  ...
  -- If we dont have the right amount of args, give an error and abort
...
-- Convert a colon-sperated line into fields
parseline :: String -> (Integer, String)
parseline input = 
  let fields = split ':' input
    in (read (fields !! 2), fields !! 0)

{- | Take a delimiter and a list. Break up the list based on the
 - delimiter. -}
split :: Eq a => a -> [a] -> [[a]]
